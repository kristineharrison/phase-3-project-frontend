...
const Container = styled.div`
  ...
  .forms {
    position: absolute;
    background-color: rgba(212, 190, 190, 0.85);
      ...
      <div className="nav-forms">
        ...
        {openformNav ? (
          <div className="forms">
            <h6
              onClick={() => {
                closeBusinessForm(!openBusinessForm);
              }}
            >
              {" "}
              Add Business Form{" "}
            ...
            {openBusinessForm ? (
              <NewBusinessForm
                functionForAddingNewBusiness={functionForAddingNewBusiness}
              />
            ) : null}
            <h6
              onClick={() => {
                closeMemberForm(!openMemberForm);
              }}
            >
              {" "}
              Add Member Form{" "}
            ...
            <h6
              onClick={() => {
                closeProjectForm(!openProjectForm);
              }}
            >
              {" "}
              Add Project Form
